package com.cloudai.server.interceptor;
...
/**
 * API Key 拦截器 — 对 /api/** 路径做简单 Token 校验。
 *
 * <p>当 {@code cloud-ai.server.api-key} 未配置时放行所有请求（开发模式）。
 * 配置后，请求必须携带 {@code X-API-Key} 头且值匹配。</p>
 *
 * @author cloud-ai
 * @since 1.0
 */
