package com.cloudai.spring.advice;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleAuth(LlmAuthException e) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(errorBody(401, "Authentication failed"));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleRateLimit(LlmRateLimitException e) {
        ...
        return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS).body(errorBody(429, "Rate limited by provider"));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleTimeout(LlmTimeoutException e) {
        ...
        return ResponseEntity.status(HttpStatus.GATEWAY_TIMEOUT).body(errorBody(504, "Request timed out"));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleServer(LlmServerException e) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(errorBody(502, "Provider server error"));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleClient(LlmClientException e) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorBody(400, "Invalid request to provider"));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleLlm(LlmException e) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorBody(500, "LLM error"));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleUnknown(Exception e) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorBody(500, "Internal error"));
    }

    private static Map<String, Object> errorBody(int code, String message) {
        return Map.of("timestamp", LocalDateTime.now().toString(), "code", code, "message", message);
    }
}